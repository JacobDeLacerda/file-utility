...
st.set_page_config(
    # Updated page_title for browser tab capitalization
    page_title="Crypto App Home",
    page_icon="🏠", # You can change this icon if you like
    layout="centered"
)

# --- Landing Page Content ---

# Capitalized title on the page itself
st.title("🔒 Welcome to the OpenSSL Crypto Tool")

# --- Image Removed ---
# The st.image(...) line that was here has been commented out/removed.
